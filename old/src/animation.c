...
void leo_DrawAnimation(leo_AnimationPlayer *player, int x, int y)
{
    ...
    leo_Rectangle sourceRec = {(float)frameX, (float)frameY, (float)anim->frameWidth, (float)anim->frameHeight};

    leo_Rectangle destRec = {(float)x, (float)y, (float)anim->frameWidth, (float)anim->frameHeight};
