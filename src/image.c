...
leo_Texture2D leo_LoadTextureFromMemory(const char *fileType, const unsigned char *data, int dataSize)
{
...
leo_Texture2D leo_LoadTextureFromPixels(const void *pixels, int width, int height, int pitch, leo_TexFormat format)
{
