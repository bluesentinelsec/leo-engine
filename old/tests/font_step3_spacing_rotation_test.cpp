...
struct GfxEnv3
{
    GfxEnv3()
    {
        REQUIRE(leo_InitWindow(640, 360, "font-step3"));
    }
    ~GfxEnv3()
    {
        leo_CloseWindow();
...
TEST_CASE_METHOD(GfxEnv3, "DrawTextPro: rotation path renders without crashing", "[font][step3]")
{
    ...
    leo_DrawTextPro(font, "Rotate!", leo_Vector2{320, 180}, leo_Vector2{320, 180}, 30.0f, 24.0f, 1.0f,
                    leo_Color{255, 220, 120, 255});
    leo_EndDrawing();
