 ...
 */
static inline size_t leo_base64_encoded_len(size_t n) {
 ...
 */
static inline size_t leo_base64_decoded_cap(size_t n) {
 ...
 */
leo_b64_result leo_base64_encode(const void* src, size_t src_len,
 ...
 * - Returns LEO_B64_E_NOSPACE if dst_cap is too small.
 */
leo_b64_result leo_base64_decode(const char* src, size_t src_len,
                                 void* dst, size_t dst_cap, size_t* out_len);

/* Convenience helpers (malloc-based). Caller must free(*out) on success. */
leo_b64_result leo_base64_encode_alloc(const void* src, size_t src_len,
                                       char** out, size_t* out_len);
leo_b64_result leo_base64_decode_alloc(const char* src, size_t src_len,
