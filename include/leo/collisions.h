...
extern "C"
{
    ...
    LEO_API bool leo_CheckCollisionCircles(leo_Vector2 center1, float radius1, leo_Vector2 center2, float radius2);

    /* Check collision between a circle and a rectangle (AABB). */
    LEO_API bool leo_CheckCollisionCircleRec(leo_Vector2 center, float radius, leo_Rectangle rec);

    /* Check if a circle collides with a line segment [p1..p2]. */
    LEO_API bool leo_CheckCollisionCircleLine(leo_Vector2 center, float radius, leo_Vector2 p1, leo_Vector2 p2);
    ...
    LEO_API bool leo_CheckCollisionPointCircle(leo_Vector2 point, leo_Vector2 center, float radius);
