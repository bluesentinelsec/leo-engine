/* ==========================================================
 * File: leo/keys.h
 * Engine-facing key aliases for Leo
 * - Provides KEY_* macros that map to SDL3 scancodes.
 * - Use these with leo_IsKeyPressed/Down/Released/etc.
 * - Keeps SDL symbols out of your game code.
 * ========================================================== */
...
#define KEY_AUDIONEXT SDL_SCANCODE_MEDIA_NEXT_TRACK
#define KEY_AUDIOPREV SDL_SCANCODE_MEDIA_PREVIOUS_TRACK
#define KEY_AUDIOSTOP SDL_SCANCODE_MEDIA_STOP
#define KEY_AUDIOPLAY SDL_SCANCODE_MEDIA_PLAY

/* ----------------------------
   International / IME
   (optional; keep for completeness)
   ---------------------------- */
